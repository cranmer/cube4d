      ...
      <aside className="panel">
        <header className="masthead">
          <div>
            <h1>Multi-view</h1>
            <p className="sub">
              One puzzle, several angles. <a href={`${import.meta.env.BASE_URL}`}>All apps</a> ·{' '}
              <a href={`${import.meta.env.BASE_URL}classic/`}>Classic</a>
            </p>
          </div>
          <a className="icon-link" href={REPO_URL} target="_blank" rel="noopener noreferrer" title="Source on GitHub">
